...
public class Mlcalc_DataDriven_TestNG_Abstract extends Abstract_Class {
        ...
        Workbook readableBook = Workbook.getWorkbook(new File("src/main/resources/Mlcalc_DataDriven_TestNG.xls"));

        //Step 2: create a writable workbook that will mimic the data from readable
         writableWorkbook = Workbook.createWorkbook(new File("src/main/resources/Mlcalc_DataDriven_TestNG_Result.xls"), readableBook);
        ...
        @Test
        public void getMonthlyPaymentsFromCalc() throws InterruptedException, WriteException {
        ...
        for (int i = 1; i < rowCount; i++) {
            ...
            logger.log(LogStatus.INFO, "  " + monthlyPayment);


            //create a label so you can add it to a cell
            Label label = new Label(4, i, monthlyPayment);
